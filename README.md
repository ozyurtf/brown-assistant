...
<a href="https://www.youtube.com/watch?v=ajAfNqeyo2Q" target="_blank" rel="noopener noreferrer" title="Watch the Brown Assistant demo on YouTube">
  <img src="images/demo.png" alt="Brown Assistant UI demo — click to watch on YouTube" width="100%" />
</a>
...
- `indexing.py`: Reads the data in `files/bulletin.json` and `files/cab.json`
    - Data is chunked and embedded with the OpenAI Embedding Model (`text-embedding-3-large`)
...
- `ui.py`: Allows users ask questions about different courses and degree requirements.
